...
#define DMA_CFG_CH_PRIOR_IDLE (0x0 << DMA_CFG_CH_PRIOR_BIT)
#define DMA_CFG_CH_PRIOR_LOW (0x1 << DMA_CFG_CH_PRIOR_BIT)
#define DMA_CFG_CH_PRIOR_MED (0x2 << DMA_CFG_CH_PRIOR_BIT)
#define DMA_CFG_CH_PRIOR_HIGH (0x3 << DMA_CFG_CH_PRIOR_BIT)
...
#define DMA_STATUS_ERROR (DMA_CHANNEL << DMA_STATUS_ERROR_BIT)
...
#define DMA_CONTROL_CLEAR_LOCAL_IRQ_M (DMA_CHANNEL << DMA_CONTROL_CLEAR_LOCAL_IRQ_BIT)
